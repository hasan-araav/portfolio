...
const StatisticCard: React.FC<StatisticProps> = ({ value, description }) => (
  <div className="flex flex-col pb-7 mt-6 border-b border-solid border-white border-opacity-10">
    <div className="text-4xl font-medium leading-10 text-lime-400">{value}</div>
    <div className="mt-1.5 text-base leading-8 text-white text-opacity-70">{description}</div>
  </div>
);
        ...
        <div className="flex gap-5 max-md:flex-col max-md:gap-0">
          <section className="flex flex-col w-[33%] max-md:ml-0 max-md:w-full">
            <header className="flex flex-col self-stretch px-4 my-auto max-w-[1650px] max-md:mt-10 max-md:max-w-full">
              ...
              <div className="flex gap-5 justify-between pt-4 mt-5 max-md:flex-wrap">
                <a
                  href="#"
          ...
          <section className="flex flex-col ml-5 w-[33%] max-md:ml-0 max-md:w-full">
            <figure className="flex flex-col grow justify-center max-w-[1650px] max-md:max-w-full">
              <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/898c1e8826082e70561aa53cdf083a79b6dec2c6ce63c3fd816c675b8d102c6d?apiKey=6fe9f02908104beead3305568f05e1a3&" className="w-full aspect-[0.9] max-md:max-w-full" alt="Depiction of Roy C. Jones" />
            </figure>
          </section>
          <section className="flex flex-col ml-5 w-[33%] max-md:ml-0 max-md:w-full">
            <aside className="flex flex-col justify-center items-end self-stretch pr-4 pl-16 my-auto max-w-[1650px] max-md:pl-5 max-md:mt-10 max-md:max-w-full">
              <div className="flex flex-col px-10 py-9 max-w-full rounded-2xl bg-zinc-950 w-[265px] max-md:px-5">
