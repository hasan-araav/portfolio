            ...
            <article className="flex flex-col w-[58%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col px-12 max-w-[1390px] max-md:px-5 max-md:max-w-full">
                ...
                <h1 className="mt-5 mr-14 text-5xl font-medium text-white leading-[54px] max-md:mr-2.5 max-md:max-w-full max-md:text-4xl max-md:leading-[53px]">
                  Professional Problem Solutions <br /> For Digital Products
                </h1>
                ...
                <div className="flex flex-wrap gap-5 gap-y-5 justify-between content-center items-start mt-8 w-full max-md:max-w-full">
                  <Service iconSrc="https://cdn.builder.io/api/v1/image/assets/TEMP/aeb17442719c98fcce39c163960565a84559d2695d341514ac913d1afb217262?apiKey=6fe9f02908104beead3305568f05e1a3&" iconAlt="Graphic representing Branding & Design" serviceTitle="Branding & Design" />
                  <Service iconSrc="https://cdn.builder.io/api/v1/image/assets/TEMP/d479eba523004d1d72eef9be3e5a650b9efe6e10323abea7c04007ce9882e862?apiKey=6fe9f02908104beead3305568f05e1a3&" iconAlt="Graphic representing Product Design" serviceTitle="Product Design" />
                  <Service iconSrc="https://cdn.builder.io/api/v1/image/assets/TEMP/12b0e60fb5e8469a5b987b129cb02856a16926488cfec75496cfc19f4b675dd7?apiKey=6fe9f02908104beead3305568f05e1a3&" iconAlt="Graphic representing Digital Marketing" serviceTitle="Digital Marketing" />
                  <Service iconSrc="https://cdn.builder.io/api/v1/image/assets/TEMP/65de91c9a434e81f3d715bf68b7f4984ad1865ff94c95a9f9ddb57d4d7c0755b?apiKey=6fe9f02908104beead3305568f05e1a3&" iconAlt="Graphic representing Web Development" serviceTitle="Web Development" />
                </div>
                <div className="flex flex-wrap gap-0 content-start px-10 pt-4 pb-1 mt-8 rounded-3xl border border-solid bg-stone-900 border-white border-opacity-10 max-md:px-5">
                  <ContactInfo iconSrc="https://cdn.builder.io/api/v1/image/assets/TEMP/67ed7c2bdd74736c51ffa0d4cf57c23ed6b6ecfa83ea8ed0886495622e06cb52?apiKey=6fe9f02908104beead3305568f05e1a3&" iconAlt="Email Icon" label="Email Us" info="support@gmail.com" />
                  <ContactInfo iconSrc="https://cdn.builder.io/api/v1/image/assets/TEMP/d7ecabd64a3d699a0aa1360db3130b1aefab5b0bcc835e8f89384425fd335ea7?apiKey=6fe9f02908104beead3305568f05e1a3&" iconAlt="Phone Icon" label="Make A Call" info="+880 (123) 456 88" />
                </div>
              </div>
            </article>
